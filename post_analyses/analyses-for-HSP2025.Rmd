...
## Import 
```{r data_import}
data <- read_csv("C:/Users/Rachel/Documents/SI.SP/post_analyses/data/data.csv",
...
```{r data_clean}
Data <- read_csv("C:/Users/Rachel/Documents/SI.SP/post_analyses/data/data_clean.csv",
    show_col_types = FALSE)
Data
```
