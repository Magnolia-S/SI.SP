...
$(document).ready(function() {
  ...
  instruction_payment = 'This experiment will take 15-20 minutes to complete. You will be paid $3.20.';
  instruction_experiment = 'The purpose of this experiment is to investigate listeners\’ ability to pay attention to a ' +
      ...
      'The experiment has two parts. In the first part, you will hear recordings of a female talker and a male talker speaking at the same time. ' +
      'Please <strong>only focus on the ' + instruction_talker + ' talker</strong>. Your task is to report ' +
  ...
  instruction_practice = '<h3>Practice for Part I</h3><p>Let\'s start with some practice.' +
      ...
      'yourself with the task. Each time you answer incorrectly, we will let you know the correct answer and the practice block will restart. ' +
      '<strong>This will not be the case during the experiment.</strong></p>';
  instruction_exposure = 'You have successfully completed the practice block. Now we can begin the experiment!<br><br> ' +
      '<h3>Experiment: Part I</h3><p>During Part I, we will ask you to perform the same task as in the practice block. ' +
      'Please remember to press the corresponding key on your keyboard to <strong>identify whether the ' + instruction_talker +
      ' talker is saying an English word or not</strong>. <br><br>' +
      'The words presented in this experiment will be <strong>common English words</strong>. '+
      'If you <em>do not</em> recognize the word, <strong>please select non-word</strong>. ' +
    ...
    var instructions = new InstructionsSubsectionsBlock(
        {
            ...
            mainInstructions: ['Thank you for your interest in our study! This is a psychology experiment investigating how people understand speech. ' +
                               'To participate, you will listen to recorded speech and press a button on your keyboard to report what you heard.',
                               '<span style="font-weight:bold;">Please read through each of the following requirements. ' +
                               'If you do not meet all requirements, we ask that you please do not take this experiment.</span> ' +
            ...
            subsections: [
                ...
                },
                {
                    ...
                    content: 'Please complete this experiment during one sitting in a quiet room, away from other noises or distractions. Please do NOT look at other web pages or other programs ' +
    ...
    if ((blocks_already_read_in) === block_type.length) {
      ...
      if ($.inArray(skipTo, ['s'].concat(Array.from(Array(22).keys()).map(n => String(n + 1)))) < 0) {
        ...
        e.addBlock({
            ...
            instructions: instruction_practice,
            onPreview: false
        });
