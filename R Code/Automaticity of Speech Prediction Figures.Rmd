...
## Figure 1A: Full adaptation to both talkers   
```{r Figure 1A}
...
### Title & Axes
  ...
  ggtitle("Figure 1A: Example /S/-/ʃ/ Perception (Full Adaptation to Both Talkers)") 
```

## Figure 1B: Inhibited adaptation to unattended talker
```{r Figure 1B}
...
### Title & Axes
  scale_x_continuous("Percent /s/ energy") +
  scale_y_continuous('Proportion of /ʃ/ responses') +
  ggtitle("Figure 1B: Example /S/-/ʃ/ Perception (Attending to Talker A)")
```
